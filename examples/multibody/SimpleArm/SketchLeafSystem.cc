...
//template <typename T>
Sketch::Sketch(): LeafSystem<double>() {
  // Declare state input port.
  state_input_port_ =
      this->DeclareVectorInputPort("state", BasicVector<double>(4))
          .get_index();
...
void SimpleArm::Sketch::CalcOutput(const Context<double>& context, BasicVector<double>* output) const{
...
//
// Created by arjunbadyal on 23/05/2023.
//

#ifndef DRAKE_SKETCHLEAFSYSTEM_H
#define DRAKE_SKETCHLEAFSYSTEM_H

#endif  // DRAKE_SKETCHLEAFSYSTEM_H
